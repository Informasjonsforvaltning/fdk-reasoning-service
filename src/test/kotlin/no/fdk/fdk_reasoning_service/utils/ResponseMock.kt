...
fun startMockServer() {
    if(!mockserver.isRunning) {
        ...
        mockserver.stubFor(get(urlEqualTo("/reference-data/eu/mobility-themes"))
        ...
        mockserver.stubFor(get(urlEqualTo("/reference-data/eu/licences"))
            .willReturn(ok(File("src/test/resources/rdf-data/reference-data/licences.ttl").readText())))
        mockserver.stubFor(get(urlEqualTo("/reference-data/eu/languages"))
            .willReturn(ok(File("src/test/resources/rdf-data/reference-data/languages.ttl").readText())))
        mockserver.stubFor(get(urlEqualTo("/reference-data/geonorge/administrative-enheter"))
        ...
        mockserver.stubFor(get(urlEqualTo("/reference-data/eu/distribution-statuses"))
            .willReturn(ok(File("src/test/resources/rdf-data/reference-data/distribution_statuses.ttl").readText())))
        mockserver.stubFor(get(urlEqualTo("/reference-data/mobility/data-standards"))
